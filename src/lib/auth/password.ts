 ...
 * Format: scrypt$<saltHex>$<keyHex> — self-describing so it can be verified
 * later without storing parameters separately.
 *
 * Plaintext passwords are never written to disk or into the repository; only
 * the output of this function belongs in ADMIN_PASSWORD_HASH.
 */
